...
export default function LogoffPage() {
  ...
  return <>
    <main className="flex justify-center items-center h-full w-full bg-[url(/desktop_back.png)] bg-cover">
      <article className="p-[40px] m-[10px] flex flex-col max-w-[360px] h-fit w-fit gap-[20px] bg-gray-50 hover:bg-gray-100 items-center justify-center transition duration-500 rounded-[50px]">
